# Circle Drawer – Java Swing Application
...
- To implement event handling using the ActionListener interface  
- To perform custom drawing by overriding the paintComponent() method  
...
- “Draw Circle” button to draw filled circles at random positions  
- “Clear” button to remove all drawings from the panel  
...
- A window titled **"Circle Drawer"** appears  
- Clicking **Draw Circle** draws a red filled circle at a random position  
...
- The application demonstrates Java Swing GUI development using JFrame, JPanel, and JButton  
- Event handling is implemented using the ActionListener interface  
- Custom drawing is achieved by overriding the paintComponent() method  
...
- Learned to create GUI applications using Java Swing  
- Understood event-driven programming concepts  
- Gained experience with custom graphics rendering  
...
**Name:** Ashik Arman Ziku  
**Course:** CSE  
**Project Type:** Academic / Lab Assignment  
